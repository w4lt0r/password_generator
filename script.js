...
function writePassword() {
  ...
  if (question1 < 8 || question1 > 128) { return alert("You didn't choose between 8 and 128 characters") }
  ...
  if (!includeUppercase && !includeLowercase && !includeNum && !includeSpecial) { return alert("You must choose at least one option") }
...
const myDog = array1[0]
const bigSTring = "sldkfjsldfjlsdkfjsl"